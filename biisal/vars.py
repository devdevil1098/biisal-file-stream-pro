...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(getenv('API_ID', '21943287'))
    API_HASH = str(getenv('API_HASH', '43b7ef733f4cf37770e737956fa3cec5'))
    BOT_TOKEN = str(getenv('BOT_TOKEN' , ''))
    name = str(getenv('name', 'Rename_fastCbbot'))
    ...
    OWNER_ID = [int(x) for x in os.environ.get("OWNER_ID", "5007198306 1947565279").split()]
    ...
    BAN_ALERT = str(getenv('BAN_ALERT' , '<b>ʏᴏᴜʀ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴛʜɪs ʙᴏᴛ.Pʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ @rishisin07 ᴛᴏ ʀᴇsᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇ!!</b>'))
